...
function () {
    ...
    function (a, b, c, d) {//滚动条
            ...
            l = a.Class.extend({
                init: function (b, c) {
                    ...
                    if ("left" === d.direction || "right" === d.direction ? this.options.scrollX ? (f = !0, this.moved || (a.gestures.session.lockDirection = !0, a.gestures.session.startDirection = d.direction)) : this.options.scrollY && !this.moved && (isReturn = !0) : "up" === d.direction || "down" === d.direction ? this.options.scrollY ? (f = !0, this.moved || (a.gestures.session.lockDirection = !0, a.gestures.session.startDirection = d.direction)) : this.options.scrollX && !this.moved && (isReturn = !0) : isReturn = !0, (this.moved || f) && (c.stopPropagation(), d.gesture && d.gesture.preventDefault()), !isReturn) {
                        ...
                        // console.log("l ============"+l)
                         this.scroller.setAttribute("data-scroll",l);//对滚动区域进行赋值
                         //this.scroller.setAttribute("data-scrollend",l);
                    ...
                    //console.log(this.y +"===========");
                    this.scroller.setAttribute("data-scrollend",Math.abs(this.y));
                    
                    /*if($(".cover").length>0){//详情页视轮播觉差
							if(this.y<=0){
								$('.cover').attr('style', 'transform:translateY('+Math.abs(this.y)/2 +'px)');
								//console.log("视觉差");
							}
            			}*/
                     this.scroller.setAttribute("data-scroll","0");
                ...
                }, _getTranslateStr: function (a, b) {//滚动条 上赋值
                	//console.log("====="+b);
        ...
        m.prototype = {
            handleEvent: function (a) {}, transitionTime: function (b) {
    ...
    */}(mui, window, document, "popover"),
    ...
    function (a, b, c) {//弹层   手风琴   左右滑动触发事件
        function d(a, b) {
